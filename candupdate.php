...
if(isset($_POST['b1']))
        {
           ...
           $nm=$_POST['name'];
            ...
            $q="select * from candidate where mobile='$mob' or name='$nm' or id='$id' ";
        ...
        if(isset($_POST['b2']))
        {
            ...
            $qua=$_POST['qua'];
            $con=mysqli_connect("localhost", "root","", "evoting");
            $q="update candidate set name='$nm',gender='$gen',address='$add',city='$city',state='$state',email='$em',age='$age',property='$ppt',symbol='$sym',qualification='$qua' where mobile='$mob'";
            mysqli_query($con,$q);
            echo"Update Success----";
        }
        ?>
...
<div class="panel panel-info">
 <div class="panel-heading">Candidate Update</div>
  <div class="panel-body" >

      <form action="candupdate.php" method="post">
