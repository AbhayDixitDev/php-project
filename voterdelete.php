...
<?php
        ...
        if(isset($_POST['b2']))
        {
                   ...
                   $photo=$_POST['photo'];
            $con=mysqli_connect("localhost", "root","", "evoting");
            $q="delete  from voter1  where adhaar='$aadh'";
            mysqli_query($con,$q);
            echo"Delete Success----";
        }
        ?>
...
<div class="panel panel-info">
 <div class="panel-heading">Voter delete</div>
  <div class="panel-body" >

      <form action="voterdelete.php" method="post">
          <div class="form-group">
            <input type="submit" class="btn btn-info " value="Search" name="b1" >
            <input type="submit" class="btn btn-info " value="Delete" name="b2" >
       </div>  
