...
<div class="panel panel-info">
 <div class="panel-heading">Voter Search By Aadhar Number</div>
  <div class="panel-body" >

      <form action="votersearchaadh.php" method="post">
      	
          	
          <div class="form-group">
                <label>Enter Voter Aadhar Number</label>
                <input type="text" name="vaadh" class="form-control" maxlength="12"/>
       </div>
...
if(isset($_POST['votersearch']))
{
    ...
    $q="select * from voter1 where adhaar='$vaadh'";
