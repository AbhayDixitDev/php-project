...
<div class="panel panel-info">
 <div class="panel-heading">Voter Search By Email Id</div>
  <div class="panel-body" >

      <form action="votersearchemail.php" method="post">
      	
          	
          <div class="form-group">
                <label>Enter Voter Email ID</label>
                <input type="text" name="vem" class="form-control" />
       </div>
...
if(isset($_POST['votersearch']))
{
    ...
    $q="select * from voter1 where email='$vem'";
