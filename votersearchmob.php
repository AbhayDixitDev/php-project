...
<div class="panel panel-info">
 <div class="panel-heading">Voter Search By Voter Mobile</div>
  <div class="panel-body" >

      <form action="votersearchmob.php" method="post">
      	
          	
          <div class="form-group">
                <label>Enter Voter Mobile Number</label>
...
if(isset($_POST['votersearch']))
{
    ...
    $q="select * from voter1 where mobile='$vmob'";
